...
impl Mmu {
    ...
    pub fn get_byte(&mut self, addr: u16) -> u8 {
        match addr {
            ...
            0xA000..=0xBFFF => self.eram[(addr - ERAM_OFFSET) as usize],
            ...
            0xE000..=0xFDFF => self.wram[(addr - ECHO_OFFSET) as usize],
    ...
    pub fn set_byte(&mut self, addr: u16, value: u8) {
        match addr {
            ...
            // A000-BFFF   8KB External RAM
            0xA000..=0xBFFF => self.eram[(addr - ERAM_OFFSET) as usize] = value,
            // C000-CFFF   4KB Work RAM Bank 0
            // D000-DFFF   4KB Work RAM Bank 1
            0xC000..=0xDFFF => self.wram[(addr - WRAM_OFFSET) as usize] = value,
            // E000-FDFF   Same as C000-DDFF (ECHO)
            0xE000..=0xFDFF => self.wram[(addr - ECHO_OFFSET) as usize] = value,
            // FE00-FE9F   Sprite Attribute Table (OAM)
            ...
            0xFF51..=0xFF7F => (), //println!("Write to io ports {:#X}", addr),
            // FF80-FFFE   High RAM (HRAM)
